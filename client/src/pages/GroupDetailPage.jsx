...
const GroupDetailPage = () => {
        ...
        <Card className="shadow-sm text-center p-4">
          <Card.Body>
            ...
            <p className="text-muted mb-4">
              요청하신 그룹을 찾을 수 없거나 데이터를 불러오는 도중 문제가
              발생했습니다.
              <br />
              잠시 후 다시 시도해 주세요.
            </p>
  ...
  return (
    <div
      className={`main-layout group-detail-page ${darkMode ? 'dark-mode' : ''}`}
    >
      <main className="main-content">
        <div className="group-detail-content">
          ...
          {groupApi.error && (
            <Alert
              variant="danger"
              onClose={() => groupApi.clearNotifications()}
              dismissible
            >
              {groupApi.error}
            </Alert>
            ...
            <div className="group-detail-right-column">
              <div className="group-detail-tabs">
                ...
                <div className="tab-content">
                  <div
                    className={`tab-pane ${activeKey === 'info' ? 'active' : ''}`}
                    id="info"
                  >
                  ...
                  {ui.get('isMember') && (
                    <div
                      className={`tab-pane ${activeKey === 'schedule' ? 'active' : ''}`}
                      id="schedule"
                    >
                      <div
                        className="tab-content-area"
                        style={{ border: 'none', boxShadow: 'none !important' }}
                      >
                  ...
                  {ui.get('isAdmin') && (
                    <>
                      <div
                        className={`tab-pane ${activeKey === 'management' ? 'active' : ''}`}
                        id="management"
                      >
                        <div className="tab-content-area">
                      ...
                      <div
                        className={`tab-pane ${activeKey === 'requests' ? 'active' : ''}`}
                        id="requests"
                      >
                        <div className="tab-content-area">
